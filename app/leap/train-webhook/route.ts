...
const prompts = [
  ...
  "capture @subject {model_type} in the glamorous style of richard avedon. use a large-format 8x10 deardorff view camera for the utmost precision. dress @subject person in a breathtaking, vintage couture gown, and place them in a grand, opulent ballroom or palace, echoing the elegance and grandeur of avedon's iconic fashion photography",
  ...
  "capture @subject {model_type} in the moody style of film noir with a focus on face details and skin texture. utilize a vintage pentax 67 medium format camera for authentic detail. dress @subject person in classic 1940s attire, and place them in a dimly lit, rain-soaked urban alley, evoking the shadowy and mysterious atmosphere of film noir while preserving their facial features and skin texture.",
